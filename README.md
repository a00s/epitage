...
## Waiting list
A new list is currently being generated using ugPlot's parallel processing tool.

Unlike the original list available in ugPlot, which was generated by running 4,000 different seeds, this new version is designed to speed up the process by evaluating seeds in batches of 30 until the results stabilize.

The list is still being generated, and its progress can be followed at the link below:

http://fy2.a00s.com:8080/reports/20260802231258-VExuFH4kaW7p

If you have ugPlot installed, you can also contribute computational resources to help process the list using the Science Collab feature available in ugPlot.
<img width="2448" height="1336" alt="image" src="https://github.com/user-attachments/assets/cf797d7b-3abb-4ff9-8fa2-bf7e94e6fc1b" />
<img width="2448" height="1403" alt="image" src="https://github.com/user-attachments/assets/e37d7247-4e1b-4791-b615-091f0e51447f" />
